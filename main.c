    ...
    switch (statusOfUart) {
        ...
        case 1:
            if (flagOfDataReceiveComplete == 1) {
                ...
                if (dataReceive[0] == 'S' && ('0' <= dataReceive[5] && dataReceive[5] <= '9')
                        && ('0' <= dataReceive[6] && dataReceive[6] <= '9') && ('0' <= dataReceive[7] && dataReceive[7] <= '9')) {
                    uartGlobalTimeOfRed = (dataReceive[5] - 48)*100 + (dataReceive[6] - 48)*10 + (dataReceive[7] - 48);
                    LcdClearS();
                ...
                if (dataReceive[10] == 'H' && ('0' <= dataReceive[15] && dataReceive[15] <= '9')
                        && ('0' <= dataReceive[16] && dataReceive[16] <= '9')) {
                    uartGlobalTimeOfRed = (dataReceive[15] - 48)*10 + (dataReceive[16] - 48);
                    LcdClearS();
                    UartSendString("HUMI=");
                    UartSendNum(uartGlobalTimeOfRed);
                    UartSendString("; ");
                ...
                if (dataReceive[19] == 'T' && ('0' <= dataReceive[24] && dataReceive[24] <= '9')
                        && ('0' <= dataReceive[25] && dataReceive[25] <= '9')) {
                    uartGlobalTimeOfRed = (dataReceive[24] - 48)*10 + (dataReceive[25] - 48);
                    LcdClearS();
                    UartSendString("TEMP=");
                    UartSendNum(uartGlobalTimeOfRed);
                    UartSendString("; ");
                ...
                if (dataReceive[28] == 'F' && ('0' <= dataReceive[32] && dataReceive[32] <= '9')) {
                    uartGlobalTimeOfRed = (dataReceive[32] - 48);
                    LcdClearS();
                    UartSendString("TEMP=");
                    if (uartGlobalTimeOfRed == 0)
                    {
                        UartSendString("OFF; ");
                    }
                    else if (uartGlobalTimeOfRed == 1)
                    {
                        UartSendString("ON; ");
                    }   
                } else {
                ...
                if (dataReceive[35] == 'L' && ('0' <= dataReceive[41] && dataReceive[41] <= '9')) {
                    uartGlobalTimeOfRed = (dataReceive[41] - 48);
                    LcdClearS();
                    UartSendString("LIGHT=");
                    if (uartGlobalTimeOfRed == 0)
                    {
                        UartSendString("OFF; ");
                    }
